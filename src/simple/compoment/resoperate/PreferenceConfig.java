 ...
 */
package simple.compoment.resoperate;

import java.lang.reflect.Field;

import simple.compoment.resoperate.util.ReflectUtils;
import android.content.Context;
import android.content.SharedPreferences;
import android.content.SharedPreferences.Editor;

/**
 * @Description: Preference类型配置文件操作类
...
public class PreferenceConfig implements IConfig {
	...
	private String filename = "PreferenceConfig";
	...
	public void loadConfig() {
		try {
			mSharedPreferences = mContext.getSharedPreferences(filename, Context.MODE_WORLD_WRITEABLE);
