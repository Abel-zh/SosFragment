...
import simple.compoment.http.FileHttpResponseHandler;
...
public class DownloadManager extends Thread
{
	...
	private BaseAsyncHttpClient syncHttpClient;
	...
	private DownloadManager(String rootPath)
	{
		...
		syncHttpClient = new BaseAsyncHttpClient();
			...
			throws MalformedURLException
	{
				...
				rootPath, StringUtils.getFileNameFromUrl(url))
		{
			...
			{
				LogUtil.d(DownloadManager.this, "Throwable");
				if (error != null)
				{
