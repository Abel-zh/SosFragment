...
//				"thinkandroid/%s (http://www.thinkandroid.cn)", VERSION));
			...
			String contentType, AsyncHttpResponseHandler responseHandler)
	{
		...
		LogUtil.d(TAGLOG.TAG_HTTP, "url-->" + url);
	 ...
	 * @param responseHandler
	 */
	public void post(String url, HashMap<String, Object> map, AsyncHttpResponseHandler responseHandler)
	{
		post(null, url, mapParamsToEntity(map), null, responseHandler);
	}
