...
import simple.framework.ioc.annotation.commen.CompareAnnotation;
 ...
 * @param <T>
 */
public class CusComparator<T> implements Comparator<T>
{
	/** 升序排列 */
	 ...
	 *            排序规则
	 */
	public CusComparator(int sortType)
	{
	 ...
	 *            排序标识
	 */
	public CusComparator(int sortType, int sortFlag)
	{
		this.sortType = sortType;
