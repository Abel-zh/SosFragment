...
import common.util.check.AndroidVersionCheckUtils;
 ...
 * </p>
 */
public abstract class CusAsyncTask<Params, Progress, Result>
{
	 ...
	 *             {@link CusAsyncTask.Status#RUNNING} or
	 *             {@link CusAsyncTask.Status#FINISHED}.
	 * 
	 * @see #executeOnExecutor(java.util.concurrent.Executor, Object[])
	 * @see #execute(Runnable)
	 */
	public final CusAsyncTask<Params, Progress, Result> execute(Params... params)
	{
	 ...
	 * @see #execute(Object[])
	 */
	public final CusAsyncTask<Params, Progress, Result> executeOnExecutor(
	...
	{
		final CusAsyncTask mTask;
		final Data[] mData;

		AsyncTaskResult(CusAsyncTask task, Data... data)
		{
			mTask = task;
			mData = data;
		}
