...
import common.compoment.universalimageloader.core.assist.FailReason.FailType;
import common.compoment.universalimageloader.core.assist.ImageScaleType;
...
import common.compoment.universalimageloader.core.decode.ImageDecodingInfo;
import common.compoment.universalimageloader.core.download.ImageDownloader;
import common.compoment.universalimageloader.core.download.ImageDownloader.Scheme;
...
import common.compoment.universalimageloader.utils.IoUtils;
...
final class LoadAndDisplayImageTask implements Runnable, IoUtils.CopyListener
{
	...
	private boolean resizeAndSaveImage(int maxWidth, int maxHeight) throws IOException
	{
		...
		if ( targetFile != null && targetFile.exists() )
		{
			...
			ImageDecodingInfo decodingInfo = new ImageDecodingInfo(memoryCacheKey, Scheme.FILE.wrap(targetFile.getAbsolutePath()), uri, targetImageSize, ViewScaleType.FIT_INSIDE,
