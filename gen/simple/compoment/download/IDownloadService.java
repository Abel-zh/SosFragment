...
public static abstract class Stub extends android.os.Binder implements simple.compoment.download.IDownloadService
{
private static final java.lang.String DESCRIPTOR = "simple.compoment.download.IDownloadService";
...
/**
 * Cast an IBinder object into an simple.compoment.download.IDownloadService interface,
 * generating a proxy if needed.
 */
public static simple.compoment.download.IDownloadService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof simple.compoment.download.IDownloadService))) {
return ((simple.compoment.download.IDownloadService)iin);
}
return new simple.compoment.download.IDownloadService.Stub.Proxy(obj);
}
...
private static class Proxy implements simple.compoment.download.IDownloadService
{
